-- Adds KoboDocs Form and KoboDocs Survey active-subscription counts to
-- the admin dashboard stats function, alongside every other subscription
-- product. Applied directly to Supabase in this session; committed here
